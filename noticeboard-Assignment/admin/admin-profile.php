...
$sql=mysqli_query($con,"update tbladmin set AdminEmailId='$email' where id='$id'");
...
<div class="col-4"><input type="text" value="<?php echo  htmlentities($row['AdminUserName']);?>"  name="username" class="form-control" readonly></div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-3">Email Id</div>
<div class="col-4"><input type="email" value="<?php echo  htmlentities($row['AdminEmailId']);?>"  name="emailid" class="form-control" required></div>
</div>
<div class="row" style="margin-top:1%;">
