...
$ret=mysqli_query($con,"SELECT id FROM tbladmin WHERE AdminUserName ='$username' and AdminEmailId='$emailid'");
$num=mysqli_num_rows($ret);
if($num>0)
{
$query=mysqli_query($con,"update tbladmin set AdminPassword='$newpassword' WHERE AdminUserName ='$username' and AdminEmailId='$emailid'");
...
return true;
 ...
 <div class="form-floating mb-3">
                                                <input class="form-control" id="emailid" name="emailid" type="email" placeholder="Contact Number" required />
