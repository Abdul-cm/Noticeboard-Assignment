...
$ret=mysqli_query($con,"SELECT id FROM tbladmin WHERE id='$adminid' and AdminPassword='$currentpassword'");
$num=mysqli_num_rows($ret);
if($num>0)
{
$query=mysqli_query($con,"update tbladmin set AdminPassword='$newpassword' WHERE id='$adminid'");
